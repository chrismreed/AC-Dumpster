      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#services" className="text-gray-400 hover:text-primary transition-colors">Residential Dumpsters</a>
              </li>
              <li>
                <a href="#services" className="text-gray-400 hover:text-primary transition-colors">Commercial Dumpsters</a>
              </li>
              <li>
                <a href="#services" className="text-gray-400 hover:text-primary transition-colors">Construction Dumpsters</a>
              </li>
              <li>
                <a href="#services" className="text-gray-400 hover:text-primary transition-colors">Junk Removal</a>
              </li>
              <li>
                <a href="#services" className="text-gray-400 hover:text-primary transition-colors">Roll-Off Containers</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:5551234567" className="text-gray-400 hover:text-primary transition-colors">(555) 123-4567</a>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 text-primary mr-2" />
                <a href="mailto:info@alleycatrental.com" className="text-gray-400 hover:text-primary transition-colors">info@alleycatrental.com</a>
              </li>
            </ul>
            <div className="mt-4">
        ...
        <div className="border-t border-gray-800 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link href="/privacy-policy">
              <div className="text-sm text-gray-500 hover:text-primary transition-colors cursor-pointer">Privacy Policy</div>
            </Link>
            <Link href="/terms-of-service">
              <div className="text-sm text-gray-500 hover:text-primary transition-colors cursor-pointer">Terms of Service</div>
            </Link>
            <Link href="/sitemap">
              <div className="text-sm text-gray-500 hover:text-primary transition-colors cursor-pointer">Sitemap</div>
            </Link>
          </div>
        </div>
      </div>
