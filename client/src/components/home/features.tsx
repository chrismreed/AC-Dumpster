  ...
  return (
    <section id="features" className="py-12 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-4 text-[#2c2c2c]">WHY CHOOSE ALLEY CAT</h2>
        <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto">We provide reliable dumpster rentals with straightforward pricing and excellent customer service.</p>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="bg-white rounded-lg shadow-lg border border-gray-100 p-6 hover:border-[#ffdd33] transition-all">
              <div className="flex items-center mb-4">
                <div className="bg-[#ffdd33] bg-opacity-20 text-[#2c2c2c] rounded-full p-3 mr-4">
                  {feature.icon}
                </div>
