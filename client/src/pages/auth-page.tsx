...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-100 pt-24 pb-12 px-4 sm:px-6 lg:px-8 mt-16">
      <div className="max-w-5xl w-full flex">
        ...
        <div className="flex-1 bg-[#0f172a] text-[#ffffff] p-12 rounded-xl shadow-xl hidden lg:flex lg:flex-col lg:justify-center border border-[#d1d5db]/20">
