...
import { DumpsterSelector } from "./dumpster-selector";
...
export function BookingForm() {
  ...
  useEffect(() => {
    ...
    if (!hasScrolled) {
      // In Next.js, we can scroll to the top of the page
  ...
  return (
    <div id="booking-form-container" className="bg-card border border-border rounded-lg shadow-md overflow-hidden">
      {!showConfirmation && (
        <BookingSteps
