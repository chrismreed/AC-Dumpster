...
import { Search, Plus, Truck, Edit, Trash2, Wrench, MapPin, Calendar, CheckCircle2, AlertCircle, Settings2, Activity, History } from 'lucide-react';
  ...
  return (
    <div className="p-4 sm:p-6 max-w-[1600px] mx-auto w-full min-w-0">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 mb-3 sm:mb-6 min-w-0">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Dumpster Inventory</h1>
      ...
      <Card className="border-none shadow-xl shadow-gray-200/50 bg-white rounded-2xl overflow-hidden">
        <div className="px-8 py-6 border-b border-gray-50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <CardTitle className="text-xl font-black text-gray-900 tracking-tight">All Dumpsters</CardTitle>
            <CardDescription className="font-medium">Showing {filteredUnits.length} dumpsters</CardDescription>
          </div>
        </div>
          ...
          <div className="overflow-x-auto">
            {filteredUnits.length === 0 ? (
              <div className="text-center py-20 bg-gray-50/30">
                ...
                <h3 className="text-xl font-black text-gray-900 mb-2">No dumpsters found</h3>
                <p className="text-gray-500 font-medium max-w-sm mx-auto">Try adjusting your filters.</p>
              </div>
            ) : (
              <Table>
                <TableHeader className="bg-gray-50/50">
                  <TableRow className="hover:bg-transparent border-gray-50">
                    <TableHead className="px-8 py-4 font-bold text-gray-400 uppercase tracking-widest text-[10px]">Unit ID</TableHead>
                    <TableHead className="py-4 font-bold text-gray-400 uppercase tracking-widest text-[10px]">Type</TableHead>
                    <TableHead className="py-4 font-bold text-gray-400 uppercase tracking-widest text-[10px]">Status</TableHead>
                    <TableHead className="py-4 font-bold text-gray-400 uppercase tracking-widest text-[10px]">Condition</TableHead>
                    <TableHead className="py-4 font-bold text-gray-400 uppercase tracking-widest text-[10px]">Location</TableHead>
                    <TableHead className="py-4 font-bold text-gray-400 uppercase tracking-widest text-[10px]">Next Service</TableHead>
                    ...
                    <TableRow key={unit.id} className="group hover:bg-gray-50/50 border-gray-50 transition-colors">
                      ...
                      <TableCell className="py-4">
                        <div className="flex flex-col">
                          <span className="font-bold text-gray-700 text-sm">{unit.dumpster?.name || 'Unknown Type'}</span>
                          <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">{unit.dumpster?.dimensions}</span>
                        </div>
                      </TableCell>
                      <TableCell className="py-4">
                      ...
                      <TableCell className="px-8 py-4 text-right">
                        <div className="flex items-center justify-end gap-2 text-gray-400">
                          ...
                          <Button
                            variant="ghost"
                            size="icon"
                            className="h-9 w-9 rounded-xl hover:bg-gray-100 transition-all"
